    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('component_Id', models.ForeignKey(db_column='COMPONENT_ID', on_delete=django.db.models.deletion.CASCADE, related_name='verifier_templates', to='masters.mstcomponent')),
